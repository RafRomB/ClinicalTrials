...
**Most of the studies' design primary porpuse is _TREATMENT_.**
...
- **Terminated**: Study halted prematurely and will not resume; participants are no longer being examined or receiving intervention
- **Withdrawn**: Study halted prematurely, prior to enrollment of first participant
- **Unknown**: A study on ClinicalTrials.gov whose last known status was recruiting; not yet recruiting; or active, not recruiting but that has passed its completion date, and the status has not been last verified within the past 2 years. Studies with an unknown status are considered closed studies.

**Filter out studies with OverallStatus WITHDRAWN or SUSPENDED**
