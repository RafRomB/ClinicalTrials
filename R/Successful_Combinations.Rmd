...
From the 201 approval notifications/171 clinical trials, **4 were not present** in the final list of retrieved clinical studies:


1. [Approval of treosulfan with fludarabine as a preparative regimen for alloHSCT in adult and pediatric patients with AML or MDS](https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-treosulfan-fludarabine-preparative-regimen-allohsct-adult-and-pediatric-patients-aml-or), [NCT00822393](https://clinicaltrials.gov/study/NCT00822393).
2. [Approval of Alimta (pemetrexed disodium) in combination with pembrolizumab and carboplatin for first-line treatment of metastatic non-squamous NSCLC](https://www.fda.gov/drugs/resources-information-approved-drugs/fda-grants-accelerated-approval-bosutinib-treatment-newly-diagnosed-ph-cml).
3. [Approval of asparaginase erwinia chrysanthemi (recombinant) for leukemia and lymphoma](https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-asparaginase-erwinia-chrysanthemi-recombinant-leukemia-and-lymphoma), [NCT04145531](https://clinicaltrials.gov/study/NCT04145531).
4. [Approval of atezolizumab as adjuvant treatment for non-small cell lung cancer](https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-atezolizumab-adjuvant-treatment-non-small-cell-lung-cancer), [NCT02486718](https://clinicaltrials.gov/study/NCT02486718).

**Reasons for exclusion**: 

- **Study 1**: The approval notification mentions _a trial comparing treosulfan to busulfan **with fludarabine** as a preparative regimen for allogeneic transplantation_. This is also mentioned in the brief summary of the study ([NCT00822393](https://clinicaltrials.gov/study/NCT00822393)), but then, the arm descriptions only include two drugs: treosulfan and busulfan.
- **Study 2**: The provided link in the FDA page is incorrect, linking the Alimta approval to a different full text, and therefore a different NCT/study.
- **Study 3**: The approval notification mentions _asparaginase erwinia chrysanthemi (recombinant)-rywn) (Rylaze, Jazz Pharmaceuticals, Inc.) as **a component of a multi-agent chemotherapeutic regimen**_. However, the study ([NCT04145531](https://clinicaltrials.gov/study/NCT04145531)) that is referenced for the approval only has one drug (JZP-458). 
- **Study 4**: Aterolizumab is used as adjuvant on top of cisplatin-based chemotherapy. The arm-defining randomized intervention is atezolizumab monotherapy vs best supportive care, and the cisplatin-based treatment is background therapy applied to both groups. This could be flagged as combination or single depending on how strict is the criteria.
